...
class AllMoviesPage extends StatefulWidget {
  ...
  const AllMoviesPage({super.key, required this.state});
  ...
  void initState() {
    setState(() {
      genres = checkGenres(widget.state.genres.genres,
          widget.state.movies.results![currentMovie].genreIds!);
    });
    super.initState();
  }
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: PageView.builder(
                  ...
                  itemCount: widget.state.movies.results!.length,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: NetworkImage(
                                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2${widget.state.movies.results![index].posterPath}"),
                                fit: BoxFit.cover),
                    ...
                    SizedBox(
                      ...
                      child: ListView(
                        children: [
                          ListTile(
                            title: Text(
                                widget.state.movies.results![currentMovie].title
                                    .toString(),
                                style: DarkMode.primaryStyle),
                          ),
                          ListTile(
                            title: Text(
                                "Date : ${widget.state.movies.results![currentMovie].releaseDate.toString().toDate()}",
                                style: DarkMode.primaryStyle),
                          ),
                          ListTile(
                            title: Text(
                                "Rate : 🌟${widget.state.movies.results![currentMovie].voteAverage}",
                                style: DarkMode.primaryStyle),
                          )
                        ],
                      ),
